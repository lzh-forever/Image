...
class HomeFragment : Fragment() {
    ...
    val list = listOf(R.drawable.national_park1,R.drawable.china6,R.drawable.food16,R.drawable.liuyifei4,R.drawable.london1,R.drawable.mountain4,R.drawable.national_park1,R.drawable.china6)
